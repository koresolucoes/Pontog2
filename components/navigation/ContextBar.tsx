 ...
 *
 * Page identity belongs to each view (one screen = one H1). This component
 * intentionally renders only truly global actions so the App Shell never
 * repeats titles/subtitles already owned by Home, Inbox, Agora, Profile, etc.
 */
export const ContextBar: React.FC<ContextBarProps> = ({ activeView, user, onOpenAccount, onOpenFilters }) => (
    <div
        className="pointer-events-none fixed left-0 right-0 top-0 z-30 px-3 sm:px-4"
